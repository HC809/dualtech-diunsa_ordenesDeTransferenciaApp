...
import { startSendProductos, startSendProductosSalida } from "../store/actions/productos/productosActions";

export const SalidaProductosScreen = () => {
                            ...
                            {loading ? (
                                ...
                                <View>
                                    ...
                                    <Button
                                        ...
                                        onPress={async () => {
                                            dispatch(startSendProductosSalida(productosEntrada, storeId!));
                                        }}
                                        status="primary"
